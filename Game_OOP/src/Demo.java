...
public class Demo extends GameStates{
    ...
    ImageIcon bg = new ImageIcon("assets/bgg.png");
    ImageIcon pus = new ImageIcon("assets/panel.png");
    ...
    void init() {
        ...
        map = new Arena(36,21);
        lava = new Lava(0,650);
        batol = new Audio("assets/battle1.wav");
        batol2 = new Audio("assets/battle2.wav");
